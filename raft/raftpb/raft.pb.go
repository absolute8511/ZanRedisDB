...
type Group struct {
	NodeId uint64 `protobuf:"varint,1,opt,name=node_id" json:"node_id"`
	Name   string `protobuf:"bytes,2,opt,name=name" json:"name"`
	// group id is the namespace id, which is unchanged in the same namespace
	GroupId uint64 `protobuf:"varint,3,opt,name=group_id" json:"group_id"`
	// replica id is the specific partition id, always increased if re-add the removed partition
	RaftReplicaId    uint64 `protobuf:"varint,4,opt,name=raft_replica_id" json:"raft_replica_id"`
	XXX_unrecognized []byte `json:"-"`
}
...
type Message struct {
	...
	FromGroup        Group       `protobuf:"bytes,13,opt,name=from_group" json:"from_group"`
	ToGroup          Group       `protobuf:"bytes,14,opt,name=to_group" json:"to_group"`
	XXX_unrecognized []byte      `json:"-"`
}
...
type ConfChange struct {
	...
	ReplicaID        uint64         `protobuf:"varint,3,opt" json:"ReplicaID"`
	NodeGroup        Group          `protobuf:"bytes,4,opt,name=node_group" json:"node_group"`
	Context          []byte         `protobuf:"bytes,5,opt" json:"Context,omitempty"`
	XXX_unrecognized []byte         `json:"-"`
}
...
func (m *Group) MarshalTo(data []byte) (n int, err error) {
	var i int
	_ = i
	var l int
	_ = l
