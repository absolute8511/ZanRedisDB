...
func (self *KVNode) registerHandler() {
	// for kv
	self.router.Register("get", self.getCommand)
	self.router.Register("mget", self.mgetCommand)
	self.router.Register("exists", self.existsCommand)
	self.router.Register("set", self.setCommand)
	self.router.Register("setnx", self.setnxCommand)
	self.router.Register("mset", self.msetCommand)
	self.router.Register("incr", self.incrCommand)
	self.router.Register("del", self.delCommand)
	self.router.Register("plget", self.plgetCommand)
	self.router.Register("plset", self.plsetCommand)
	// for hash
	self.router.Register("hget", self.hgetCommand)
	self.router.Register("hgetall", self.hgetallCommand)
	self.router.Register("hkeys", self.hkeysCommand)
	self.router.Register("hexists", self.hexistsCommand)
	self.router.Register("hmget", self.hmgetCommand)
	self.router.Register("hlen", self.hlenCommand)
	self.router.Register("hset", self.hsetCommand)
	self.router.Register("hmset", self.hmsetCommand)
	self.router.Register("hdel", self.hdelCommand)
	self.router.Register("hincrby", self.hincrbyCommand)
	self.router.Register("hclear", self.hclearCommand)
	// for list
	self.router.Register("lindex", self.lindexCommand)
	self.router.Register("llen", self.llenCommand)
	self.router.Register("lrange", self.lrangeCommand)
	self.router.Register("lpop", self.lpopCommand)
	self.router.Register("lpush", self.lpushCommand)
	self.router.Register("lset", self.lsetCommand)
	self.router.Register("ltrim", self.ltrimCommand)
	self.router.Register("rpop", self.rpopCommand)
	self.router.Register("rpush", self.rpushCommand)
	self.router.Register("lclear", self.lclearCommand)
	// for zset
	self.router.Register("zscore", self.zscoreCommand)
	self.router.Register("zcount", self.zcountCommand)
	self.router.Register("zcard", self.zcardCommand)
	self.router.Register("zlexcount", self.zlexcountCommand)
	self.router.Register("zrange", self.zrangeCommand)
	self.router.Register("zrevrange", self.zrevrangeCommand)
	self.router.Register("zrangebylex", self.zrangebylexCommand)
	self.router.Register("zrangebyscore", self.zrangebyscoreCommand)
	self.router.Register("zrevrangebyscore", self.zrevrangebyscoreCommand)
	self.router.Register("zrank", self.zrankCommand)
	self.router.Register("zrevrank", self.zrevrankCommand)
	self.router.Register("zadd", self.zaddCommand)
	self.router.Register("zincrby", self.zincrbyCommand)
	self.router.Register("zrem", self.zremCommand)
	...
	self.router.Register("zclear", self.zclearCommand)
